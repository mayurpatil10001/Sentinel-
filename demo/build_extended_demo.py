...
<div class="c">
  ...
  <div class="sgrid">
    ...
    <div class="scol">
      ...
      <div class="sit"><strong>Real-case SEBI backtest UNTESTABLE via public data</strong>Three real SEBI enforcement orders identified. All case scrips confirmed absent from NSE bhavcopy and NSE symbol master (two independent data sources, log-verified). BSE-only status is the most probable explanation but has not been independently verified against BSE data — structurally untestable without confirmed BSE data access or official data sharing.</div>
